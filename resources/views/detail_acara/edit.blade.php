...
@else
    <form id="form-detail-acara" method="POST">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nama_detail_acara" name="nama_detail_acara"
                        value="{{ $detail_acara->nama_detail_acara }}" placeholder="Masukan Nama Acara">
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="alamat_detail_acara" name="alamat_detail_acara" value="{{ $detail_acara->alamat_detail_acara }}" 
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="lokasi_detail_acara" name="lokasi_detail_acara"
                        placeholder="Masukan link lokasi" value="{{ $detail_acara->lokasi_detail_acara }}" >
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control" id="tanggal_detail_acara" name="tanggal_detail_acara"
                        placeholder="Masukan link lokasi" value="{{ $detail_acara->tanggal_detail_acara }}">
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="time" class="form-control" id="waktu_mulai" name="waktu_mulai"
                        placeholder="Masukan link lokasi" value="{{ $detail_acara->waktu_mulai }}">
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="time" class="form-control" id="waktu_selesai" name="waktu_selesai"
                        placeholder="Masukan link lokasi" value="{{ $detail_acara->waktu_selesai }}">
            ...
            <div class="col-md-12">
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="deskripsi_detail_acara" name="deskripsi_detail_acara" rows="3">{{ $detail_acara->deskripsi_detail_acara }}</textarea>
         ...
         <div class="d-flex justify-content-end">
            <button type="button" class="btn btn-primary mb-3" onclick="update('{{ $detail_acara->id }}')">Simpan</button>
        </div>
    </form>
@endif
